...
Consider a volume $V$ enclosed by a closed surface $S$. Charge conversation tells us that $I = \frac{-d}{dt} Q$. Therefore $\int \vec{j} \cdot \vec{n} dS = \frac{-d}{dt} \int \rho dV$.
